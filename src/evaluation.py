...
def simple_eval(dataloader, GPT2_LM, parallel_GPT2_LM, n_facet_effective, args):
    ...
    with torch.no_grad():
        for i_batch, sample_batched in enumerate(dataloader):
            ...
            if args.n_facet == 0:
                ...
                outputs, emb_div, count_best_arr, weight, emb_div_arr_vis, loss_seq_vis, MRR_seq_vis, loss_raw, MRR_raw, div_raw = parallel_GPT2_LM(feature, labels=feature)
    ...
    return total_loss / data_size, total_div / data_size, total_count_best_arr / data_size, total_weights_arr / data_size, total_emb_div_arr_vis / data_size, total_loss_seq_vis / data_size, total_MRR_seq_vis / data_size
    ...
    with torch.no_grad():
        ...
        for i_batch, sample_batched in enumerate(dataloader):
            ...
            if args.n_facet == 0:
                ...
                outputs, emb_div, count_best_arr, weight, emb_div_arr_vis, loss_seq_vis, MRR_seq_vis, loss_raw, MRR_raw, div_raw, dist_to_period, div_weighted_sq_raw, collapse_difference, collapse_difference_inv, collapse_difference_val, facet_norm, top_val_single, top_idx_single = parallel_GPT2_LM(feature, labels=feature, eval_recon_top_k = args.eval_recon_top_k)
